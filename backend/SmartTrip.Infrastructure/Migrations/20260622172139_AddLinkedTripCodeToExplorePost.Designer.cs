...
namespace SmartTrip.Infrastructure.Migrations
{
    ...
    [Migration("20260622172139_AddLinkedTripCodeToExplorePost")]
    partial class AddLinkedTripCodeToExplorePost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartTrip.Domain.Entities.ChatHistory", b =>
                {
                    ...
                    b.Property<string>("ClassifierDetails")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool?>("IsFallbackUsed")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsJsonValid")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SmartTrip.Domain.Entities.ExplorePost", b =>
                {
                    ...
                    b.Property<string>("LinkedTripCode")
                        .HasMaxLength(20)
                        .IsUnicode(false)
                        .HasColumnType("varchar(20)");
            ...
            modelBuilder.Entity("SmartTrip.Domain.Entities.VehicleRentalShop", b =>
                {
                    ...
                    b.Property<decimal>("MonthlyAgreementFee")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 2)")
                        .HasDefaultValue(0m);

                    b.Property<DateTime?>("MonthlyFeePaidAt")
                        .HasColumnType("datetime");
